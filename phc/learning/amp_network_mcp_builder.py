...
class AMPMCPBuilder(AMPBuilder):
    ...
    class Network(AMPBuilder.Network):
        ...
        def __init__(self, params, **kwargs):
            ...
            composer_mlp_args = {"input_size": self._calc_input_size((self.self_obs_size + self.task_obs_size,), self.actor_cnn), "units": self.units + [self.num_primitive], "activation": self.activation, "norm_func_name": self.normalization, "dense_func": torch.nn.Linear, "d2rl": self.is_d2rl, "norm_only_first_layer": self.norm_only_first_layer}
